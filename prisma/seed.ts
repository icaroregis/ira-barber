...
import { PrismaClient } from "../src/app/_generated/prisma/client";
...
async function seedDatabase() {
  try {
    ...
    // Limpa os dados do seed antes de inserir novamente.
    await prisma.$transaction([
      prisma.booking.deleteMany(),
      prisma.barbershopServices.deleteMany(),
      prisma.barbershop.deleteMany(),
    ]);

    // Cria 10 barbearias com nomes e endereços fictícios
    for (let i = 0; i < 10; i++) {
